...
import fr.xam74er1.trellodrone.tellolib.communication.CommandCallback;
import fr.xam74er1.trellodrone.tellolib.communication.TelloCommunicationInterface;
import fr.xam74er1.trellodrone.tellolib.drone.TelloDrone;
import fr.xam74er1.trellodrone.tellolib.exception.TelloCommandException;
...
{
  private String TAG = "trello comunication"; 
          ...
          TelloCommandException
  {
    ...
    if (command != "battery?")Log.i(TAG,"executing command: " + command);
